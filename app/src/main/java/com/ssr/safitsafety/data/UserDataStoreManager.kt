...
object UserDataStoreManager {
    ...
    private val EMERGENCY_CONTACTS_PREF_KEY = stringPreferencesKey(MainActivity.EMERGENCY_CONTACTS_PREF_KEY)
    ...
    suspend fun saveUserData(context: Context, userData: UserData): Result<Unit> {
        ...
        return try {
            context.dataStore.edit { preferences ->
                ...
                preferences[EMERGENCY_CONTACTS_PREF_KEY] = serializePhoneNumbers(userData.phoneNumber)
